...
although Google allows fairly extensive customization including light and dark themes for the button
which can be enabled. Currently, dark is the only theme accessible through this package.
